  ...
  return (
    <div>
      <CommentSection
        ...
        comments={comments}
        objectId={objectId}
        addComment={(user, objectId, text) =>
          addComment(type, user, objectId, text, id)
        }
        // (id, typeofOpinion, type, commentId, fastIndex)
        likeComment={(objectId, commentId, fastIndex) =>
          actionToComment(objectId, 'like', type, commentId, fastIndex, id)
        }
        dislikeComment={(objectId, commentId, fastIndex) =>
          actionToComment(objectId, 'dislike', type, commentId, fastIndex, id)
        }
      />
    </div>
  );
