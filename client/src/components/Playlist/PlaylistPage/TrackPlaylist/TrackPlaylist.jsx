...
function TrackPlaylist({
  ...
  const height = detectMobile() ? '' : '25px';
  return (
    // d - flex justify - content - between align - items - center
    <li
      className={`list-group-item ${classNameBorder}`}
      ref={dragElement}
      draggable={edit}
    ...
    >
      <div className="row container" style={{ height }}>
...
by 
        ...
        <span
          className="col-md-2 badge badge-primary badge-pill"
          style={{ height: '100%' }}
        >
          {duration}
        </span>
